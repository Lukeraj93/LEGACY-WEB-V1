...
async function main() {
  ...
  report.pages.clientDashboard = await pageCheck("/client-dashboard.html", ["What To Expect Inside Your Coaching Plan"]);
  report.pages.coachProgramming = await pageCheck("/coach-programming.html", ["Template Builder", "Nutrition + Health", "Review Queue"]);
